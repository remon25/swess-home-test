      ...
      <v-row>
        ...
        <v-col cols="4">
          ...
          <a :href="'/artical/' + item[0].id" class="no_decoration">
            <v-card class="mx-auto elevation-0" max-width="300">
              <div class="hover">
                <v-img eager class="d-border-radius " src="/images/service-one.webp" height="369px"
                  width="300px"></v-img>
              </div>
              <v-row class="mt-5">
        ...
        <v-col cols="4">
          <a :href="'/artical/' + item[1].id" class="no_decoration">
            ...
            <v-img eager class="d-border-radius" src="/images/service-two.webp" height="369px"
                  width="300px"></v-img>
              </div>
            </v-card>
          </a>
          ...
          <a :href="'/artical/' + item[2].id" class="no_decoration">
            ...
            <v-card class="mx-auto elevation-0" max-width="300">
              <div class="hover">
                ...
                <v-img eager class="d-border-radius" src="/images/service-three.webp" height="369px"
                  width="300px"></v-img>
              </div>
              <v-row class="mt-5">
                <!-- <v-col cols="4" style="overflow: visible">
    ...
    <v-container class="d-md-block d-lg-none" v-if="!isLoad">
      <v-row>
        ...
        <v-col cols="12">
          ...
          <v-img eager style="border-radius: 20px" src="/images/service-one.webp" height="369px"
                width="300px"></v-img>
              <v-col cols="12">
        ...
        <v-col cols="12">
          <v-card class="mx-auto elevation-0" max-width="300">
            <a :href="'/artical/' + item[1].id" class="no_decoration">
              ...
              <v-img eager style="border-radius: 20px" src="/images/service-two.webp" height="369px"
                width="300px"></v-img>
              <v-col cols="12">
                <p class="h6 d-text-dark_gray mt-5">{{ $i18n.locale == 'ar' ? item[1].title.split("|")[0] :
                item[1].title.split("|")[1]
        ...
        <v-col cols="12">
          <v-card class="mx-auto elevation-0" max-width="300">
            <a :href="'/artical/' + item[2].id" class="no_decoration">
              ...
              <v-img eager style="border-radius: 20px" src="/images/service-three.webp" height="369px"
                width="300px"></v-img>
              <v-col cols="12">
