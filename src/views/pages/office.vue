    ...
    <v-container v-if="(item.length > 0)">
      <v-row v-if="!isload">
        <v-col cols="12" md="12" lg="3">
          <v-card class="d-border-radius  contract-box text-center" :class="
        ...
        <v-col cols="12" md="12" lg="9" >
          <v-col cols="12">
            ...
            <p class="body1 d-text-primary">
              <a style="text-decoration: none" :href="'tel:' + item[0].office.mobile"><span dir="ltr">{{
              item[0].office.mobile
              }}</span>
                <img src="/icons/phone.svg" class="mx-3" alt="phone" /></a>
            </p>

            <p class="body1 d-text-primary">
              <a style="text-decoration: none" :href="'https://wa.me/' + item[0].office.mobile"><span dir="ltr">{{
              item[0].office.mobile
              }}</span>
                <img alt="whatsapp" src="/icons/whatsapp.svg" class="mx-3" /></a>
            </p>
          ...
          <v-col cols="12">
            <div class="mt-2">
              <div class="d-md-inline mx-5">
                ...
                <span class="mx-2">{{ item[0].office.numOfEstatesForRent }}</span>
              </div>
              <div class="d-md-inline mx-5">
                <p class="d-inline subtitle2 d-text-primary">
                  {{ $t('NumberofEstateforsale') }} :
                </p>
                <span class="mx-2">{{ item[0].office.numOfEstatesForSell }}</span>
              </div>
            </div>
          </v-col>
          <v-col cols="12">
          ...
          <v-col cols="12" style="padding: 5px;">
            ...
            <v-col cols="12" >
              <div v-if="!(visibleItem.length == 0)">
                ...
                <v-pagination dir="ltr" circle v-model="page" color="#2170B4" :length="Math.ceil(item.length / perPage)"
