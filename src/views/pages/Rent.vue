<template>
  <div class="d-block" style="margin-bottom:100px">
    <v-row no-gutters>
          ...
          <v-row>
            <v-col cols="12" style=" padding-top: 100px"
              ...
              <p class="d-text-secandary h6 d-block">
                {{ $t("rentBestWayToSearchForEstate") }}
              </p>
              <p class="d-text-dark h3 d-block">
                {{ $t("rentYouCanSearchForHouse") }}
              </p>
            </v-col>
          </v-row>
        </div>
        <SocialMedia></SocialMedia>
        <homeFilter tab="two" style="padding-top: 400px;"></homeFilter>
      </v-col>
...
export default {
  ...
  mounted() {
    document.title = i18n.t("rent_page");
